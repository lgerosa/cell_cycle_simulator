function [kG1S kSG2 kG2M kMG1 papG1 papS papG2 papM Vcc Kcc ncc Vap Kap nap] = DM_param_example1_G1_G2_block_all_apoptosis()
...
Kcc=[1;  Inf; 1;   Inf]; %drug concentration for half maximal effect 
ncc=[1;    1;    1;    1;  ]; %steepness of drug effect 

%define the dose-dependent drug effects on apoptosis
     %G1    S     G2     M
Vap=[0.1;   0.1;  0.1;   0.1]; %maximal rate on hill equation 
Kap=[1;     1;    1;     1]; %drug concentration for half maximal effect 
