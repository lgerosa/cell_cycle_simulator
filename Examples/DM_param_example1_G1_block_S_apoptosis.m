function [kG1S kSG2 kG2M kMG1 papG1 papS papG2 papM Vcc Kcc ncc Vap Kap nap] = DM_param_example1_G1_block_S_apoptosis()
...
%define the dose-dependent drug effects on apoptosis
     %G1    S     G2     M
Vap=[papG1; 1; papG2;  papM]; %maximal rate on hill equation 
Kap=[Inf;   0.1;  Inf;     Inf]; %drug concentration for half maximal effect 
